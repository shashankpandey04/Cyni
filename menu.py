...
class SetupBot(discord.ui.Select):
    ...
    async def callback(self,interaction: discord.Interaction):
      if self.values[0] == "Staff Roles":
        ...
        game_staff_role_mentions = [f"<@&{role_id}>" for role_id in server_config['game_staff_roles']]
        embed = discord.Embed(
                    title="Server Config",
        ...
        if game_staff_role_mentions:
                  embed.add_field(name="Game Staff Roles", value="Enabled", inline=False)
                  embed.add_field(name="**Game Staff Roles:**", value='\n'.join(game_staff_role_mentions)) 
        else:
                  embed.add_field(name="Game Staff Roles", value="Disabled", inline=False)
...
class SelectStaffRoleSelect(discord.ui.Select):
    def __init__ (self):
      options = [
         ...
         discord.SelectOption(label="Game Staff Roles",description="Select Game Staff Roles",emoji="🎮")
      ]
